...
namespace kiko {
	...
	void Particle::Draw(Renderer& renderer)
	{
		...
		renderer.DrawLine(m_data.position.x, m_data.position.y,
			m_data.prevPosition.x, m_data.prevPosition.y);
	}


}
//Create a global Particle System (g_particleSystem) in the ParticleSystem.h/.cpp.

// Make sure to set the maximum number of particles in the constructor.