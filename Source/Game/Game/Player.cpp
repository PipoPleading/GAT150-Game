...
namespace kiko
{
	bool Player::Initialize()
	{
		...
		auto collisionComponent = GetActor<kiko::CollisionComponent>();
		if (collisionComponent)
		{
			auto renderComponent = GetActor<kiko::RenderComponent>();
			if (renderComponent)
			{
	...
	void Player::Update(float dt)
	{
		...
		auto physicComponent = GetActor<kiko::PhysicComponent>(); //passing the components, need to rename to GetComponents
		physicComponent->ApplyForce(forward * speed * thrust);
